  ...
  return (
    ...
    <div className="footer-center">
        <div>
            ...
            <p><span>BML Munjal University, NH-48</span>
        ...
        <div>
            ...
            <p><a href="mailto:purpleaudience@gmail.com">purpleaudience@gmail.com</a></p>
        </div>
    </div>
    <div className="footer-right">
        <p className="footer-company-about">
            <span>About Our Initiative</span>
            <span> Purple Audience is a comprehensive mental health website that aims to provide valuable resources, support, and information to individuals seeking assistance, understanding, and empowerment on their mental well-being journey.</span>
        </p>
